...
| [026](ADR-026-nxtlvl-wiki-mcp-source.md) | `nxtlvl-wiki` becomes a queryable MCP source — a new `wiki-scout` agent inherits ADR-002's leads-only posture, never Context7's testify tier | Accepted |
