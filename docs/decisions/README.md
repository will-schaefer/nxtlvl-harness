...
| [012](ADR-012-github-workflow-skill-and-conventions.md) | GitHub workflow standardized as a vendored skill composing the `nxtlvl:review` agent; Conventional Commits, no attribution | Accepted |
