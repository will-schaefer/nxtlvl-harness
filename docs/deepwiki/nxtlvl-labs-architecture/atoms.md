...
> Atom-level coverage of the `nxtlvl-labs` plugin. Most atoms are speculative because the plugin
...
| ID | Atom | Status | Priority | Dependency Layer | Pointer / note |
|---|---|---|---|---|---|
| LAB-B1 | Plugin manifest | PLANNED | foundational | packaging | `nxtlvl-labs` plugin identity |
| LAB-B2 | Marketplace / install mechanism | PLANNED | foundational | packaging | Local-marketplace install |
...
| LAB-B7 | MCP server config | PLANNED | foundational | packaging | Lab MCP servers |
| LAB-B8 | Namespace | PLANNED | foundational | packaging | `nxtlvl-labs:` prefix |
| LAB-B9 | Versioning / promotion tag | OPEN | phase-1 | packaging | Lab promotion tag ritual |
| LAB-B10 | Dev/prod separation for labs | PLANNED | foundational | packaging | Lab repo = workbench |
...
| ID | Atom | Status | Priority | Dependency Layer | Pointer / note |
|---|---|---|---|---|---|
| LAB-C1 | Lab command | PLANNED | phase-0 | components | Entry points for lab workflows |
| LAB-C2 | Lab agent | PLANNED | phase-0 | components | Meta-builder agents |
| LAB-C3 | Lab skill | PLANNED | phase-0 | components | Meta-builder skills |
| LAB-C4 | Lab rule | PLANNED | foundational | components | Lab always-on shaping |
...
| LAB-C7 | Lab MCP tool | PLANNED | phase-0 | components | Lab MCP servers |
| LAB-C8 | Typed output contract for lab artifacts | PLANNED | phase-0 | components | Schema for lab artifacts |
| LAB-C9 | Lab alias / router entry | PLANNED | phase-0 | components | Lab slash entries |
...
| LAB-C12 | Shared library | PLANNED | foundational | components | Lab shared libs; may duplicate core libs for standalone |
...
| LAB-D2 | Lab project memory file | PLANNED | foundational | context | Per-project lab memory |
...
| LAB-E2 | Experiment capture | PLANNED | foundational | memory | Capture experiment runs |
...
| LAB-E5 | Experiment recall | PLANNED | phase-0 | memory | Recall past experiments |
| LAB-E6 | Experiment scoping | PLANNED | foundational | memory | Bind experiments to projects |
...
| LAB-H4 | MCP server integration | PLANNED | phase-0 | tooling | Same as core |
| LAB-H5 | Docs grounding (primary-source) | PLANNED | phase-0 | tooling | Same as core |
| LAB-H6 | Repo orientation (non-evidence) | PLANNED | phase-0 | tooling | Same as core |
...
| LAB-I3 | Promotion gate | PLANNED | foundational | quality | Graduation to core |
...
| Family | NATIVE | PLANNED | OPEN | REJECTED | OOS | Total |
|---|---|---|---|---|---|---|
| LAB-A | 8 | 0 | 0 | 0 | 0 | 8 |
| LAB-B | 1 | 7 | 3 | 0 | 1 | 12 |
| LAB-C | 1 | 9 | 2 | 0 | 0 | 12 |
...
> **Note:** The labs plugin is speculative. Most atoms are planned or open and will be refined once the plugin's first version is designed.
