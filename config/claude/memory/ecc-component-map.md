...
The ECC reference repo at `reference/ECC-main` (ECC = "Everything Claude Code" / npm `ecc-universal`, a harness-native agent OS) was exhaustively mapped on 2026-06-16 into **`docs/reference/ecc-main-map.md`**.
